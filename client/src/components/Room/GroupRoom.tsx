...
import { Box, Stack, Typography, Button, AvatarGroup, Avatar as MuiAvatar } from '@mui/material';
...
const GroupRoom: React.FC<{ group: IRoom }> = ({ group }) => {
  ...
  return (
    ...
    >
      ...
      <Stack justifyContent="space-between" alignItems="center" direction="row" flexGrow={1} sx={{ ml: '8px' }}>
